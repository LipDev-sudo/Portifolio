    ...
    <footer className="border-t-[2.5px] border-border-light bg-dark text-white py-8 px-6">
      <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-2">
          <span className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center text-white font-bold text-xs">
            L
          </span>
        ...
        <div className="flex items-center gap-5">
          <a
            ...
            aria-label="GitHub"
            className="text-white/40 hover:text-accent-lime transition-colors"
          >
            <GithubIcon size={20} />
          </a>
          <a
