          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground font-medium">
                your friendly AI automation dev
              </p>
              <p className="text-xs text-muted-foreground/50 mt-0.5">
                &copy; {new Date().getFullYear()} Hamilton Felipe. {t.footer.rights}
              </p>
            </div>
          </div>

          <p className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tighter text-foreground/10 select-none">
            LipDev
          </p>
        </div>
      </div>
